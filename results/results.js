...
const diedSpan = document.getElementById('died-span');
...
if (user.hp <= 0) {;
    died = `Tragically, ${user.name} died in the fairy lands and never returned to the farm.`;
} else if  (user.hp === 20) {
